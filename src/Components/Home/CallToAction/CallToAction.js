            ...
            <div className="text-center space-y-5">
                ...
                <p className="mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl">Discover
                    ...
                    <span className="px-2 py-1 relative inline-block">
                        <svg className="stroke-current bottom-0 absolute primary-text -translate-x-2" viewBox="0 0 410 18"
                ...
                <p className="max-w-3xl mt-5 mx-auto text-xl text-gray-500">
                    Sign Up now and discover the impact of our educational services in just one week.
                </p>
    
                <div className="flex flex-col sm:flex-row space-y-2.5 sm:space-y-0 sm:space-x-2.5 items-center justify-center">
                    <a  className="w-full sm:w-auto sm:mt-0 mt-2 sm:ml-0 ml-2">
                        <button type="button"
                            className="flex items-center justify-center gap-4 px-4 py-3 w-full border  primary-border shadow-sm font-medium rounded-full  hover:text-white hover:bg-black transition duration-250 ease-in-out">
